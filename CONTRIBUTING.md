# Note
One aim of pixi-shapes is to make it as easy as possible for existing pixi.js contributors
to contribute to pixi-shapes. So the guidelines are the same as for pixi.js
